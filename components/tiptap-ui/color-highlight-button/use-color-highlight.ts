...
export const HIGHLIGHT_COLORS = [
  { label: "Midnight", value: "#0D152D", colorValue: "#0D152D", border: "#0D152D" },
  { label: "Sand", value: "#F4F1D3", colorValue: "#F4F1D3", border: "#e5e7eb" },
  { label: "Bordeaux", value: "#6B1F2A", colorValue: "#6B1F2A", border: "#6B1F2A" },
  { label: "Sage", value: "#6F7A5C", colorValue: "#6F7A5C", border: "#6F7A5C" },
  { label: "Terracotta", value: "#B96A4A", colorValue: "#B96A4A", border: "#B96A4A" },
  { label: "Gold", value: "#B08442", colorValue: "#B08442", border: "#B08442" },
  { label: "Paper", value: "#FAF8F2", colorValue: "#FAF8F2", border: "#e5e7eb" },
  { label: "Paper 2", value: "#F0ECE0", colorValue: "#F0ECE0", border: "#e5e7eb" },
  { label: "Ivory", value: "#FFFFFF", colorValue: "#FFFFFF", border: "#e5e7eb" },
]
